...
<AccordionGroup>
  ...
  <Accordion title="Book Appointment" icon="calendar">
    ...
    **Coming Soon:**
    ...
    <Frame>
      <img src="/images/chat-tool-book-appointment.png" alt="Book Appointment" />
    </Frame>
  ...
  <Accordion title="MCP Server" icon="server">
    Connect to Model Context Protocol (MCP) servers for advanced integrations.

    **Configuration:**

    1. Add the MCP server URL
    2. Select specific tools from the server
    3. Configure authentication if required

    <Frame>
      <img src="/images/chat-tool-mcp-server.png" alt="MCP Server" />
    </Frame>

    **Use Cases:**
    - Connect to Zapier's MCP server for hundreds of integrations
    - Link to custom MCP servers you've built
    - Access specialized AI tools and services
    - Integrate with enterprise systems

    <Note>
      MCP servers provide a standardized way for AI agents to interact with external tools and data sources during live calls.
    </Note>
