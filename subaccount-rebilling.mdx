...
`chat_rate` is now inherited from your Agency Company settings and applied at the subaccount level. This keeps chat pricing consistent across all subaccounts under the same agency configuration.
