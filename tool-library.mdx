...
<AccordionGroup>
  <Accordion title="Create Ecommerce Customer" icon="user-plus">
    ...
    **Configurations (You set once):**
    *None required—uses your MailerLite integration*

    **Use Cases:**
    - Sync shop customers
    - Onboard new purchases
    - Create customer records
    - Update customer information
...
<AccordionGroup>
  <Accordion title="Chats Get All Chats" icon="comments">
    ...
    **Configurations (You set once):**
    *None required—uses your Microsoft Teams integration*
...
<AccordionGroup>
  <Accordion title="Archive Item" icon="archive">
    ...
    **Configurations (You set once):**
    *None required—uses your Monday.com integration*

    **Use Cases:**
    - Archive completed items
    - Move items to archive
    - Clean up active boards
    - Organize board items
  ...
  <Accordion title="Move Item To Board" icon="arrow-right">
    ...
    **Use Cases:**
    ...
    - Transfer items
    - Reorganize items
    - Move items to different boards
  ...
  <Accordion title="Move Item To Group" icon="arrow-right">
    ...
    **Use Cases:**
    ...
    - Reorganize board items
    - Change item group
    - Restructure board groups
...
<AccordionGroup>
  <Accordion title="Append Block Children" icon="plus">
    ...
    **Configurations (You set once):**
    *None required—uses your Notion integration*

    **Use Cases:**
    - Add advanced blocks
    - Append nested structures
    - Insert complex block types
    - Add pre-built block objects
  ...
  <Accordion title="Fetch Block Contents" icon="file-lines">
    ...
    **Use Cases:**
    ...
    - Access block children
    - Read nested blocks
    - Fetch block structure
...
<AccordionGroup>
  <Accordion title="Calendar Create Event" icon="calendar-plus">
    ...
    **Configurations (You set once):**
    *None required—uses your Outlook integration*
...
<AccordionGroup>
  <Accordion title="Create Incident Record" icon="plus">
    ...
    **Configurations (You set once):**
    *None required—uses your PagerDuty integration*
  ...
  <Accordion title="Fetch Related Incidents By Id" icon="link">
    ...
    **Use Cases:**
    ...
    - Analyze incident relationships
...
<AccordionGroup>
  <Accordion title="Create Contact" icon="user-plus">
    ...
    **Configurations (You set once):**
    *None required—uses your PandaDoc integration*
...
<AccordionGroup>
  <Accordion title="Perplexity Ai Search" icon="magnifying-glass">
    ...
    **Configurations (You set once):**
    *None required—uses your Perplexity AI integration*

    **Use Cases:**
    - Perform AI-powered searches
    - Get answers with citations
    - Search with AI assistance
    - Retrieve information with sources
...
<AccordionGroup>
  <Accordion title="Add A Call Log" icon="phone">
    ...
    **Configurations (You set once):**
    *None required—uses your Pipedrive integration*
  ...
  <Accordion title="Add A Comment To A Note" icon="comment">
    ...
    **Use Cases:**
    ...
    - Comment on notes
    - Provide note feedback
    - Add note discussions
  ...
  <Accordion title="Add A Follower To An Organization" icon="user-plus">
    ...
    **Use Cases:**
    - Add organization followers
    - Notify team members
    - Share organization updates
    - Add organization watchers
  ...
  <Accordion title="Add A Follower To A Product" icon="user-plus">
    ...
    **Use Cases:**
    - Add product followers
    - Notify team members
    - Share product updates
    - Add product watchers
  ...
  <Accordion title="Add An Installment Subscription" icon="plus">
    ...
    **Use Cases:**
    - Create installment subscriptions
    - Add payment plans
    - Set up installments
  ...
  <Accordion title="Delete An Organization" icon="trash">
    ...
    **Use Cases:**
    ...
    - Mark organizations as deleted
    - Clean up organization records
  ...
  <Accordion title="Delete A Participant From A Deal" icon="trash">
    ...
    **Use Cases:**
    - Remove deal participants
    - Delete participants
    - Unlink people from deals
  ...
  <Accordion title="Delete A Person" icon="trash">
    ...
    **Use Cases:**
    - Delete contacts
    - Remove people
    - Mark people as deleted
    - Clean up person records
  ...
  <Accordion title="Get Deals Where A Product Is Attached To" icon="list">
    ...
    **Use Cases:**
    - Find deals with product
    - View product deals
    - Get related deals
    - Access product associations
  ...
  <Accordion title="List Activities Associated With An Organization" icon="list">
    ...
    **Use Cases:**
    ...
    - Get activity list
    - Retrieve organization activities
    - Access activity history
  ...
  <Accordion title="List Activities Associated With A Person" icon="list">
    ...
    **Use Cases:**
    - View person activities
    - Get activity list
    - Retrieve person activities
    - Access activity history
  ...
  <Accordion title="List Deals Associated With An Organization" icon="list">
    ...
    **Use Cases:**
    - View organization deals
    - Get deal list
    - Retrieve organization deals
    - Access deal history
...
<AccordionGroup>
  <Accordion title="Cancel Email" icon="xmark">
    ...
    **Configurations (You set once):**
    *None required—uses your Resend integration*

    **Use Cases:**
    - Cancel scheduled emails
    - Stop email delivery
    - Cancel pending emails
    - Remove scheduled sends
...
<AccordionGroup>
  <Accordion title="Add Opportunity Line Item" icon="plus">
    ...
    **Configurations (You set once):**
    *None required—uses your Salesforce integration*

    **Use Cases:**
    - Add products to opportunities
    - Attach products to deals
    - Include products in opportunities
  ...
  <Accordion title="Associate Contact To Account" icon="link">
    ...
    **Use Cases:**
    ...
    - Update contact account relationship
  ...
  <Accordion title="Clone Opportunity With Products" icon="copy">
    ...
    **Use Cases:**
    - Clone opportunities
    - Duplicate deals with products
    - Copy opportunity structure
    - Create opportunity copies
  ...
  <Accordion title="Search Opportunities" icon="magnifying-glass">
    ...
    **Use Cases:**
    ...
    - Search opportunity information
...
<AccordionGroup>
  <Accordion title="Create Customer" icon="user-plus">
    ...
    **Configurations (You set once):**
    *None required—uses your Shopify integration*
  ...
  <Accordion title="Get Customer Orders" icon="list">
    ...
    **Use Cases:**
    ...
    - Get customer orders
    - Retrieve order list for customer
  ...
  <Accordion title="Update Order" icon="pencil">
    ...
    **Use Cases:**
    ...
    - Change order contact information
    - Modify order details
...
<AccordionGroup>
  <Accordion title="Create A Reminder" icon="bell">
    ...
    **Configurations (You set once):**
    *None required—uses your Slack integration*
  ...
  <Accordion title="List Canvases" icon="list">
    ...
    **Use Cases:**
    ...
    - Retrieve Canvas list
    - Access available Canvases
...
<AccordionGroup>
  <Accordion title="Cancel Subscription" icon="xmark">
    ...
    **Configurations (You set once):**
    *None required—uses your Stripe integration*

    **Use Cases:**
    - Cancel subscriptions
    - End customer subscriptions
  ...
  <Accordion title="List Payment Intents" icon="list">
    ...
    **Use Cases:**
    ...
    - View payment intent history
    - Retrieve payment intents
    - Access payment intent records
  ...
  <Accordion title="List Shipping Rates" icon="truck">
    ...
    **Use Cases:**
    ...
    - Access shipping rate directory
  ...
  <Accordion title="List Subscriptions" icon="list">
    ...
    **Use Cases:**
    ...
    - View subscription directory
    - Retrieve subscriptions
    - Access subscription records
...
<AccordionGroup>
  <Accordion title="Get Collectors" icon="list">
    ...
    **Configurations (You set once):**
    *None required—uses your SurveyMonkey integration*
  ...
  <Accordion title="Get Responses" icon="list">
    ...
    **Use Cases:**
    ...
    - Get response data
    - Retrieve response list
    - Access survey answers
...
<AccordionGroup>
  <Accordion title="Send Message" icon="paper-plane">
    ...
    **Configurations (You set once):**
    *None required—uses your Telegram integration*
...
<AccordionGroup>
  <Accordion title="Add Cards" icon="plus">
    ...
    **Configurations (You set once):**
    *None required—uses your Trello integration*
  ...
  <Accordion title="Add Cards Actions Comments By Id Card" icon="comment">
    ...
    **Use Cases:**
    ...
    - Comment on cards
    - Provide card feedback
    - Add card discussions
  ...
  <Accordion title="Update Checklists By Id Checklist" icon="pencil">
    ...
    **Use Cases:**
    - Update checklists
    - Modify checklist properties
    - Change checklist details
