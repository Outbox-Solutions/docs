...
<AccordionGroup>
  ...
  <Accordion title="Create Opportunity" icon="bullseye">
    Create a new **opportunity** in your pipeline from the conversation—useful when a lead is qualified, a deal is identified, or you want a record in CRM-style stages.

    Pair with the [Opportunities](/opportunities) tab to manage pipelines and stages.

  </Accordion>

  <Accordion title="Update Opportunity" icon="pen-to-square">
    Update an existing opportunity (for example **stage**, value, or fields you configure) so the pipeline stays in sync with what the agent learned on the call or in chat.
...
<AccordionGroup>
  ...
  <Accordion title="Create Job Payment" icon="credit-card">
    Create a new job payment in ServiceM8.
  ...
  <Accordion title="Delete Job Note" icon="trash">
    Delete a job note in ServiceM8.

    **Description:**
    Deletes (archives) a job note in ServiceM8 by its UUID. Use this tool when you need to remove a note from a job diary. In ServiceM8, deletion is a soft-delete: the note is archived (active=0) rather than permanently removed, and can be restored later if needed. Prerequisites: You need the note UUID, which can be obtained from the List All Job Notes or Retrieve Job Note actions.

  </Accordion>

  <Accordion title="Delete Job Payment" icon="trash">
    Archive a job payment in ServiceM8.

    **Description:**
    Archives (soft-deletes) a job payment record in ServiceM8 by its UUID. In ServiceM8, records are never permanently deleted. Instead, deletion sets the record active field to 0, which hides it from the UI but keeps it accessible via the API. Archived records can be restored by setting their active field back to 1. Use this tool when you need to remove a payment record from active use, such as when a payment was recorded in error or needs to be voided. Requires the manage_job_payments OAuth scope.

  </Accordion>

  <Accordion title="List All Assets" icon="box">
    List all ServiceM8 assets.
  ...
  <Accordion title="List All Document Templates" icon="file-lines">
    List all document templates in ServiceM8.
  ...
  <Accordion title="List All Job Notes" icon="note-sticky">
    ...
    **Description:**
    List all job notes from ServiceM8. Use this tool to retrieve all notes across all jobs (no filter), get notes for a specific job using filter related_object_uuid eq job_uuid, or filter by active status. The response contains a list of note records with their content, timestamps, and associated job UUIDs.
  ...
  <Accordion title="List All Materials" icon="box-open">
    List all materials in ServiceM8.
  ...
  <Accordion title="Retrieve Client" icon="user">
    Retrieve a specific client from ServiceM8.
  ...
  <Accordion title="Retrieve Form" icon="clipboard">
    Retrieve a specific form template from ServiceM8.
  ...
  <Accordion title="Retrieve Job" icon="briefcase">
    Retrieve a specific job from ServiceM8.
  ...
  <Accordion title="Retrieve Job Activity" icon="clock">
    Retrieve a specific job activity from ServiceM8.
  ...
  <Accordion title="Retrieve Job Note" icon="note-sticky">
    Retrieve a specific job note from ServiceM8.
  ...
  <Accordion title="Retrieve Job Payment" icon="credit-card">
    Retrieve a specific job payment from ServiceM8.

    **Description:**
    Retrieve a specific job payment record from ServiceM8 by its UUID. Use this tool when you need to get full details of a specific payment (amount, method, timestamp, notes), check if a payment is a deposit or regular payment, view which staff member processed a payment, or verify payment information for a job. Prerequisites: You need the job payment UUID, which can be obtained from the List All Job Payments action or from creating a new job payment.

  </Accordion>

  <Accordion title="Retrieve Job Queue" icon="list">
    Retrieve a specific job queue from ServiceM8.
  ...
  <Accordion title="Retrieve Location" icon="map-marker-alt">
    Retrieve a specific location from ServiceM8.
  ...
  <Accordion title="Retrieve Material" icon="box-open">
    Retrieve a specific material from ServiceM8.
  ...
  <Accordion title="Retrieve Staff Member" icon="user-tie">
    Retrieve a specific staff member from ServiceM8.
  ...
  <Accordion title="Update Job Note" icon="pen">
    Update an existing job note in ServiceM8.
  ...
  <Accordion title="Update Job Payment" icon="credit-card">
    Update an existing job payment in ServiceM8.
